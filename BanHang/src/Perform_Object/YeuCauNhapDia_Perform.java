...
public class YeuCauNhapDia_Perform {
	...
	public YeuCauNhapDia_Perform(String maYeuCau, LocalDate ngayYeuCau, String donViCungCap, String trangThaiNhap) {
		super();
		MaYeuCau = maYeuCau;
		NgayYeuCau = ngayYeuCau;
		DonViCungCap = donViCungCap;
